...
class MLPGateDataset(InMemoryDataset):
    ...
    def processed_dir(self):
        ...
        if self.args.no_rc:
            name += '_norc'
        # PA2-3: distinct cache per label file so Markov labels don't collide with i.i.d.
    ...
    def process(self):
        ...
        for cir_idx, cir_name in enumerate(circuits):
            ...
            # PA2-3: optional transition-probability label (legacy labels.npz lacks this key)
